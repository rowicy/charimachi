...
func GetViolationRates(c *gin.Context) {
	...
	violationRates := []ViolationRate{
		{ViolationRate: 0.1, Coordinate: []float64{139.701961, 35.689727}, Message: "違反が多い箇所です"},
		{ViolationRate: 0.2, Coordinate: []float64{139.760530, 35.707620}, Message: "違反が多い箇所です"},
	}
